...
export const InvoiceCard: React.FC<InvoiceCardProps> = ({ invoice }) => {
  ...
  const invoiceNumber =
    invoice.invoice_uid || `INV-${invoice.id.substring(0, 6)}`;
  ...
  return (
    <Card
      className={`h-full transition-all duration-300 ${isExpanded ? "shadow-lg" : "hover:shadow-md"} hover:border-primary/50`}
    >
