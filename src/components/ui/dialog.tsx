...
// This file has an error with the children prop type. Let's make it generic or explicitly accept ReactNode.
// Since this is a shadcn component, we should rebuild it to correctly type children.
// We'll use React.ReactNode as the type for children.
