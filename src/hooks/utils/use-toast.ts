...
/**
 * Type definition for toast with additional properties
 */
 ...
 * 
 * This hook provides methods to create, update, and dismiss toast notifications
 * in the application. It uses a reducer pattern for state management.
 * 
