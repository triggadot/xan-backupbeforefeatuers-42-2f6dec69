...
# SECURITY SETTINGS
# ------------------------------
# Set permissions for files and directories (022 is standard)
umask 022

# Set more restrictive permissions for WSL environment if detected
if grep -q Microsoft /proc/version; then
    # Ensure umask is properly set for WSL
    umask 022

    # WSL-specific settings
    # Improve Windows interoperability
